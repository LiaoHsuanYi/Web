...
app.config['SQLALCHEMY_DATABASE_URI'] = 'postgresql://postgres:rootroot@localhost/my_hotel'
...
def login():
    ...
    if form.validate_on_submit():
        if form.username.data == "admin" and form.passwd.data == "admin":
            ...
            login_data = db.session.execute(text('SELECT login_name, login_password FROM login where login_name=:username'),
